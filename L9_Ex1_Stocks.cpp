...
class Stock
{
	...
	public:
		...
		Stock(const string, int, double); // parametric constructor
		Stock(const string);
...
{	
	...
	/* Stock input;
	cin >> input;
	cout << "Input company Name: " << input << endl;
	input.acquire(input,0,0); */
...
/* Stock::Stock(const string)
{
	acquire("Ameren", 0, 0.0);
	//cout << "Input company string: " << endl;
	//acquire(" ", 0, 0.0);
	set_tot();
